...
C
     ...
     &                  runoff_ESMF,what_is_in_ESMF
      ...
      INTEGER , PARAMETER :: HAS_ESMF_SFLUX = 4
      INTEGER , PARAMETER :: HAS_ESMF_SWFLUX = 5
      INTEGER , PARAMETER :: HAS_ESMF_UWIND = 6
      INTEGER , PARAMETER :: HAS_ESMF_VWIND = 7
      INTEGER , PARAMETER :: HAS_ESMF_WSPEED = 8
      INTEGER , PARAMETER :: HAS_ESMF_ATEMP = 9
      INTEGER , PARAMETER :: HAS_ESMF_AQH = 10
      INTEGER , PARAMETER :: HAS_ESMF_LWFLUX = 11
      INTEGER , PARAMETER :: HAS_ESMF_EVAP = 12
      INTEGER , PARAMETER :: HAS_ESMF_PRECIP = 13
      INTEGER , PARAMETER :: HAS_ESMF_SNOWPRECIP = 14
      INTEGER , PARAMETER :: HAS_ESMF_SWDOWN = 15
      ...
      _RL   uwind_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL   vwind_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL  wspeed_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL   atemp_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL     aqh_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL  lwflux_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL   evap_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL  precip_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL snowprecip_ESMF(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL swdown_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL lwdown_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL apressure_ESMF(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL runoff_ESMF   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
#endif
